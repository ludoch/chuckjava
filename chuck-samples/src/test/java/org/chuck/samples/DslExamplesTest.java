...
/**
 * Tests for Java DSL examples in src/main/java/org/chuck/samples/dsl/.
 *
...
public class DslExamplesTest {
  ...
  public void testSineDSL() throws Exception {
    ...
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/SineDSL.java")));
  ...
  public void testFmDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/FmDSL.java")));
  ...
  public void testAdsrDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/AdsrDSL.java")));
  ...
  public void testEnvelopeDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/EnvelopeDSL.java")));
  ...
  public void testLfoDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/LfoDSL.java")));
  ...
  public void testPhasorDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/PhasorDSL.java")));
  ...
  public void testCombDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/CombDSL.java")));
  ...
  public void testChirpDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/ChirpDSL.java")));
  ...
  public void testBlitDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/BlitDSL.java")));
  ...
  public void testHarmonicsDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/HarmonicsDSL.java")));
  ...
  public void testWindDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/WindDSL.java")));
  ...
  public void testOscillatorsDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/OscillatorsDSL.java")));
  ...
  public void testFm2DSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/Fm2DSL.java")));
  ...
  public void testBlit2DSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/Blit2DSL.java")));
  ...
  public void testLarryDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/LarryDSL.java")));
  ...
  public void testLpfDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/LpfDSL.java")));
  ...
  public void testBpfDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/BpfDSL.java")));
  ...
  public void testResonZDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/ResonZDSL.java")));
  ...
  public void testChorusDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/ChorusDSL.java")));
  ...
  public void testClarDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/ClarDSL.java")));
  ...
  public void testWurleyDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/WurleyDSL.java")));
  ...
  public void testDslDemo() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/DslDemo.java")));
  ...
  public void testPolyphonyDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/PolyphonyDSL.java")));
  ...
  public void testMandolinDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/MandolinDSL.java")));
  ...
  public void testBarDSL() throws Exception {
    ChuckVM vm = new ChuckVM(SAMPLE_RATE);
    vm.spork(ChuckDSL.load(Paths.get("src/main/java/org/chuck/samples/dsl/BarDSL.java")));
