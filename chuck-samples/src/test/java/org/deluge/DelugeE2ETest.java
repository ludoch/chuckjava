...
public class DelugeE2ETest {
  ...
  public void testSequencerWorkflow() throws Exception {
    ...
    try (java.io.InputStream is = getClass().getResourceAsStream("/SONGS/song1.xml")) {
      ...
      org.deluge.model.ProjectModel model = org.deluge.xml.DelugeXmlParser.parseSong(is, "song1");
  ...
  public void testSidebarLoadPreset() throws Exception {
    ...
    org.deluge.ui.SwingProjectSidebarPanel sidebar =
        new org.deluge.ui.SwingProjectSidebarPanel(vm, bridge, null);
  ...
  public void testSongPlayback(String songFile) throws Exception {
    ...
    org.deluge.firmware.model.Song song =
        org.deluge.firmware.engine.FirmwareFactory.createSong(project);
    org.deluge.firmware.engine.FirmwareAudioEngine audioEngine =
        new org.deluge.firmware.engine.FirmwareAudioEngine();
    for (org.deluge.firmware.model.Clip c : song.clips) {
