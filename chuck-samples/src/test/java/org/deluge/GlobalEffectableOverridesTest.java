...
class GlobalEffectableOverridesTest {
  ...
  void setUp() {
    ...
    bridge.register(vm);
    app = new SwingDelugeApp(vm, bridge, null);
  ...
  void kitTrackClipOverridesVolumeAndPan() {
    ...
    assertEquals(0.5f, vm.getGlobalFloat(BridgeContract.G_SP_VOLUME), 0.001f);
    assertEquals(-0.3f, vm.getGlobalFloat(BridgeContract.G_SP_PAN), 0.001f);
  }
  ...
  void kitTrackClipOverridesAllReverbDelay() {
    ...
    assertEquals(0.8f, vm.getGlobalFloat(BridgeContract.G_SP_REVERB_AMOUNT), 0.001f);
    assertEquals(0.25f, vm.getGlobalFloat(BridgeContract.G_SP_DELAY_RATE), 0.001f);
    assertEquals(0.6f, vm.getGlobalFloat(BridgeContract.G_SP_DELAY_FEEDBACK), 0.001f);
  }
  ...
  void kitTrackClipOverridesModFxAndStutter() {
    ...
    assertEquals(0.3f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_RATE), 0.001f);
    assertEquals(0.7f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_DEPTH), 0.001f);
    assertEquals(0.2f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_OFFSET), 0.001f);
    assertEquals(0.4f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_FEEDBACK), 0.001f);
    assertEquals(0.9f, vm.getGlobalFloat(BridgeContract.G_SP_STUTTER_RATE), 0.001f);
    assertEquals(0.1f, vm.getGlobalFloat(BridgeContract.G_SP_SAMPLE_RATE_REDUCTION), 0.001f);
    assertEquals(0.0f, vm.getGlobalFloat(BridgeContract.G_SP_BITCRUSH), 0.001f);
  }
  ...
  void kitTrackClipOverridesFiltersAndEq() {
    ...
    assertEquals(8000.0f, vm.getGlobalFloat(BridgeContract.G_SP_LPF_FREQ), 0.001f);
    assertEquals(0.5f, vm.getGlobalFloat(BridgeContract.G_SP_LPF_RES), 0.001f);
    assertEquals(100.0f, vm.getGlobalFloat(BridgeContract.G_SP_HPF_FREQ), 0.001f);
    assertEquals(0.3f, vm.getGlobalFloat(BridgeContract.G_SP_HPF_RES), 0.001f);
    assertEquals(-6.0f, vm.getGlobalFloat(BridgeContract.G_SP_EQ_BASS), 0.001f);
    assertEquals(3.0f, vm.getGlobalFloat(BridgeContract.G_SP_EQ_TREBLE), 0.001f);
    assertEquals(0.7f, vm.getGlobalFloat(BridgeContract.G_SP_LPF_MORPH), 0.001f);
    assertEquals(0.2f, vm.getGlobalFloat(BridgeContract.G_SP_HPF_MORPH), 0.001f);
  }
  ...
  void kitClipWithoutOverridesPreservesSongDefaults() {
    ...
    assertEquals(0.8f, vm.getGlobalFloat(BridgeContract.G_SP_VOLUME), 0.001f);
    assertEquals(0.1f, vm.getGlobalFloat(BridgeContract.G_SP_PAN), 0.001f);
    assertEquals(0.5f, vm.getGlobalFloat(BridgeContract.G_SP_REVERB_AMOUNT), 0.001f);
    assertEquals(0.2f, vm.getGlobalFloat(BridgeContract.G_SP_DELAY_RATE), 0.001f);
    assertEquals(0.4f, vm.getGlobalFloat(BridgeContract.G_SP_DELAY_FEEDBACK), 0.001f);
  }
  ...
  void kitTrackPartialOverridesLeaveOthersAtSongDefault() {
    ...
    assertEquals(0.6f, vm.getGlobalFloat(BridgeContract.G_SP_VOLUME), 0.001f);
    // reverbAmount not overridden — should still be song default
    assertEquals(0.3f, vm.getGlobalFloat(BridgeContract.G_SP_REVERB_AMOUNT), 0.001f);
  }
  ...
  void audioTrackClipOverridesVolume() {
    ...
    assertEquals(0.4f, vm.getGlobalFloat(BridgeContract.G_SP_VOLUME), 0.001f);
  }
  ...
  void audioTrackClipOverridesReverbDelay() {
    ...
    assertEquals(0.7f, vm.getGlobalFloat(BridgeContract.G_SP_REVERB_AMOUNT), 0.001f);
    assertEquals(0.15f, vm.getGlobalFloat(BridgeContract.G_SP_DELAY_RATE), 0.001f);
    assertEquals(0.5f, vm.getGlobalFloat(BridgeContract.G_SP_DELAY_FEEDBACK), 0.001f);
  }
  ...
  void audioTrackClipOverridesModFx() {
    ...
    assertEquals(0.6f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_RATE), 0.001f);
    assertEquals(0.3f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_DEPTH), 0.001f);
    assertEquals(0.8f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_OFFSET), 0.001f);
    assertEquals(0.9f, vm.getGlobalFloat(BridgeContract.G_SP_MOD_FX_FEEDBACK), 0.001f);
  }
  ...
  void audioTrackClipOverridesFiltersAndEq() {
    ...
    assertEquals(12000.0f, vm.getGlobalFloat(BridgeContract.G_SP_LPF_FREQ), 0.001f);
    assertEquals(0.4f, vm.getGlobalFloat(BridgeContract.G_SP_LPF_RES), 0.001f);
    assertEquals(200.0f, vm.getGlobalFloat(BridgeContract.G_SP_HPF_FREQ), 0.001f);
    assertEquals(0.2f, vm.getGlobalFloat(BridgeContract.G_SP_HPF_RES), 0.001f);
    assertEquals(-3.0f, vm.getGlobalFloat(BridgeContract.G_SP_EQ_BASS), 0.001f);
    assertEquals(1.5f, vm.getGlobalFloat(BridgeContract.G_SP_EQ_TREBLE), 0.001f);
    assertEquals(200.0f, vm.getGlobalFloat(BridgeContract.G_SP_EQ_BASS_FREQ), 0.001f);
    assertEquals(6000.0f, vm.getGlobalFloat(BridgeContract.G_SP_EQ_TREBLE_FREQ), 0.001f);
  }
  ...
  void audioTrackClipWithoutOverridesPreservesSongDefaults() {
    ...
    assertEquals(1.0f, vm.getGlobalFloat(BridgeContract.G_SP_VOLUME), 0.001f);
    // AudioClip reverbAmount default is 0, which overrides song's 0.4
    assertEquals(0.0f, vm.getGlobalFloat(BridgeContract.G_SP_REVERB_AMOUNT), 0.001f);
