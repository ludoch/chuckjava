...
public class LiveAutomationMpeTest {
  ...
  void testMidiRealtimeTransportControls() {
    ...
    vm.setGlobalObject(org.deluge.BridgeContract.G_PLAYBACK_HANDLER, playbackHandler);

    org.deluge.midi.MidiInputRouter router = new org.deluge.midi.MidiInputRouter(vm, bridge);
    org.deluge.midi.MidiService service = new org.deluge.midi.MidiService(vm, bridge, router);
