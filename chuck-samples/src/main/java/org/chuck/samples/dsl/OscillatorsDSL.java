...
/**
 * All-oscillators showcase using the Java Fluent DSL. Mixes SinOsc, SawOsc, TriOsc, PulseOsc,
 * SqrOsc, and FM (TriOsc->SinOsc) and plays random pentatonic notes.
 *
 * <p>Original ChucK (oscillatronx.ck): uses array of Osc, random note selection.
 */
