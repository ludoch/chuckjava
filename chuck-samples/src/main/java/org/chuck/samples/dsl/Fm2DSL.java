...
/**
 * Simple FM Synthesis (sync=2 mode) using the Java Fluent DSL. A modulator SinOsc drives a carrier
 * SinOsc in FM mode.
 *
 * <p>Original ChucK (fm2.ck): SinOsc m => SinOsc c => dac; 440 => c.freq; 110 => m.freq; 300 =>
 * m.gain; 2 => c.sync; while(true) 1::second => now;
 */
