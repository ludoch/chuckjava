...
/**
 * BLIT + ADSR + Reverb example using the Java Fluent DSL. Plays 12 articulated pentatonic notes
 * with attack/decay shaping and reverb.
 *
 * <p>Original ChucK (blit2.ck): Blit s => ADSR e => JCRev r => dac; e.set(5::ms, 3::ms, .5, 5::ms);
