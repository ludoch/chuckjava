...
/**
 * Wurley (FM Electric Piano) example using the Java Fluent DSL. Plays random notes from a minor
 * pentatonic scale with slight frequency drift.
 *
 * <p>Original ChucK (stk/wurley.ck): Wurley voc => JCRev r => dac; while(true) { random note;
 * random velocity => voc.noteOn; 250::ms => now; }
 */
