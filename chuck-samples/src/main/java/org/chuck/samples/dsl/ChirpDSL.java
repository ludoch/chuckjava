...
/**
 * Chirp (frequency sweep) example using the Java Fluent DSL. Sweeps from MIDI 127 down to 20, then
 * 20 up to 120 with a coarser step.
 *
 * <p>Original ChucK (chirp.ck): SinOsc s => dac; .4 => s.gain; chirp(127, 20, 1::second); chirp(20,
 * 120, 1.5::second, 100::ms);
 */
public class ChirpDSL implements Shred {
  ...
  private void chirp(
      double src,
      double target,
      org.chuck.core.ChuckDuration duration,
