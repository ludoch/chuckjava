...
/**
 * Linear Envelope example using the Java Fluent DSL. Runs white noise through a linear envelope for
 * 3 bursts.
 *
 * <p>Original ChucK (envelope.ck): Noise n => Envelope e => dac; while(true) {
 * Math.random2f(10,500)::ms => dur t => e.duration; e.keyOn(); 800::ms => now; e.keyOff(); 800::ms
 * => now; }
 */
