# Deluge Song XML Examples

This document stores the example `song.xml` files provided by the user to serve as the authoritative reference for achieving full compatibility.
...
<song>
    ...
    <preview></preview>
    ...
    <instruments>
        <kit>
            ...
            <presetSlot>0</presetSlot>
            <presetSubSlot>0</presetSubSlot>
            <soundSources>
                <sound>
                    <name>KICK</name>
                    <osc1>
                        ...
                        <fileName>SAMPLES/DRUMS/Kick/909 Kick distorted.wav</fileName>
                        <zone>
                            <startMilliseconds>0</startMilliseconds>
                            <endMilliseconds>369</endMilliseconds>
                            <startSamplePos>0</startSamplePos>
                            <endSamplePos>16289</endSamplePos>
                        </zone>
                    </osc1>
                    <osc2>
                        <type>sample</type>
                ...
                <!-- Additional sounds omitted for brevity -->
            </soundSources>
        </kit>
    </instruments>
    <tracks>
        <track>
            <noteRows>
                <noteRow>
                    <noteData>0x000000180000000C40140000003C0000000C4014000000600000000C4014000000780000000C4014</noteData>
                </noteRow>
            </noteRows>
        </track>
    </tracks>
...
<song>
    <previewNumPads>144</previewNumPads>
    <!-- preview data omitted -->
    <instruments>
        <sound>
            <presetSlot>5</presetSlot>
            <!-- synth params omitted -->
        </sound>
    </instruments>
    <tracks>
        <track>
            <noteRows>
                <noteRow>
                    <y>60</y>
                    <noteData>0x000000180000000C4014000000480000000C40140000006C0000000C40140000009C0000000C4014000000B40000000C4014</noteData>
                </noteRow>
            </noteRows>
        </track>
    </tracks>
