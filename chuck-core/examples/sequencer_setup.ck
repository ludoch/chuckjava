...
"chuck-core/examples/data/kick.wav" => kit[0].read;
"chuck-core/examples/data/snare.wav" => kit[1].read;
"chuck-core/examples/data/hihat.wav" => kit[2].read;
"chuck-core/examples/data/hihat-open.wav" => kit[3].read;
"chuck-core/examples/book/digital-artists/audio/clap_01.wav" => kit[4].read;
"chuck-core/examples/book/digital-artists/audio/cowbell_01.wav" => kit[5].read;
"chuck-core/examples/book/digital-artists/audio/click_01.wav" => kit[6].read;
"chuck-core/examples/data/snare-hop.wav" => kit[7].read;
