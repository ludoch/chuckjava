...
/**
 * STK allpass-interpolating delay line (DelayA), ported verbatim from ugen_stk.cpp. Plain DSP
 * object ticked directly by the waveguide instruments. Double precision to match STK's MY_FLOAT.
 */
