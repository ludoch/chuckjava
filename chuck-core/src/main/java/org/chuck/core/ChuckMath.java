...
/** Bridge for ChucK's Math module. Delegates to java.lang.Math and Std where appropriate. */
public class ChuckMath {
  ...
  public static long random2(long min, long max) {
    return Std.rand2(min, max);
  }

  public static double random2f(double min, double max) {
