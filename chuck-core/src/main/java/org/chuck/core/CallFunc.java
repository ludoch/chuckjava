...
/**
 * Instruction to call a ChucK function. Pushes the current Code, PC, and the pre-args reg.sp onto
 * the mem stack, so ReturnFunc can restore the stack pointer and eliminate the arg leak.
 */
