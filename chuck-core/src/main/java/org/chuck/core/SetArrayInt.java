...
/**
 * Sets an element in an indexed array via the ChucK => operator. Stack layout (top first): [Index,
 * ArrayObj, Value]
 *
 * <p>For UGen arrays: if both value and array[index] are ChuckUGens, wires them (src.chuckTo(dest))
 * and pushes dest for chaining. For primitive/object arrays: stores the value and pushes it back.
 */
