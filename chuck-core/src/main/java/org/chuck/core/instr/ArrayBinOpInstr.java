...
public abstract class ArrayBinOpInstr implements ChuckInstr {
  ...
  public void execute(ChuckVM vm, ChuckShred s) {
    ...
    ChuckArray rhs =
        (rObj instanceof ChuckArray ra) ? ra : new ChuckArray(ChuckType.ARRAY, defaultSize);
    ChuckArray lhs =
        (lObj instanceof ChuckArray la) ? la : new ChuckArray(ChuckType.ARRAY, defaultSize);
