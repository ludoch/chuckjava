 ...
 *
 * Each test:
 *  - Compiles and loads the DSL file via ChuckDSL.load()
 *  - Sporks the shred into a headless ChuckVM
 *  - Advances simulated time and verifies expected behaviour
 */
public class DslExamplesTest {
    ...
    /**
     * Run the VM for {@code seconds} of simulated audio, returning the peak
     * per-buffer RMS seen across all DAC channels.
     */
    ...
    public void testSineDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "SineDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testFmDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "FmDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testAdsrDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "AdsrDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testEnvelopeDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "EnvelopeDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testLfoDSL() throws Exception {
        ...
        assertDoesNotThrow(() -> runAndMeasure(vm, 2.0),
                "LfoDSL should run without throwing exceptions");
    }
    ...
    public void testPhasorDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "PhasorDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testCombDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 2.0);
        assertTrue(maxRms > 0.0001,
                "CombDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testChirpDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "ChirpDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testBlitDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "BlitDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testHarmonicsDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 4.0);
        assertTrue(maxRms > 0.001,
                "HarmonicsDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testWindDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "WindDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testOscillatorsDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "OscillatorsDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testFm2DSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 4.0);
        assertTrue(maxRms > 0.001,
                "Fm2DSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testBlit2DSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "Blit2DSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testLarryDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "LarryDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testLpfDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "LpfDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testBpfDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "BpfDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testResonZDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 3.0);
        assertTrue(maxRms > 0.001,
                "ResonZDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testChorusDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 4.0);
        assertTrue(maxRms > 0.001,
                "ChorusDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testClarDSL() throws Exception {
        ...
        assertTrue(maxRms > 0.001,
                "ClarDSL produced no sound (maxRms=" + maxRms + ")");
    }
    ...
    public void testWurleyDSL() throws Exception {
        ...
        double maxRms = runAndMeasure(vm, 5.0);
        assertTrue(maxRms > 0.001,
                "WurleyDSL produced no sound (maxRms=" + maxRms + ")");
    }
}
