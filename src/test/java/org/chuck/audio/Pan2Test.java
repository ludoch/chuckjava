...
public class Pan2Test {
  ...
  public void testPan2Panning() {
    ...
    assertEquals(
        pan3.getLastOutLeft(),
        pan3.getLastOutRight(),
        0.001f,
        "Left and right should be equal at center");
    ...
    assertEquals(
        ...
        pan4.getLastOutLeft(),
        0.001f,
        "Left channel should have correct constant power gain");
    assertEquals(
        0.9239f,
        pan4.getLastOutRight(),
        0.001f,
        "Right channel should have correct constant power gain");
  }
}
