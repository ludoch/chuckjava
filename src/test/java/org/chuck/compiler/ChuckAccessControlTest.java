...
public class ChuckAccessControlTest {
    ...
    private List<String> runChuck(String code) throws InterruptedException {
        ...
        vm.addPrintListener(s -> {
            ...
            if (trimmed.startsWith("Machine.run error:") || trimmed.startsWith("java.lang.RuntimeException:")) {
    ...
    public void testPrivateMethodAccessFails() throws InterruptedException {
        ...
        runChuck(code);
        assertTrue(errorOutput.stream().anyMatch(s -> s.contains("cannot access private method 'bar:0'")),
    ...
    public void testPrivateFieldAccessFails() throws InterruptedException {
        ...
        runChuck(code);
        assertTrue(errorOutput.stream().anyMatch(s -> s.contains("cannot access private field 'x'")),
    ...
    public void testProtectedAccessFailsForNonSubclass() throws InterruptedException {
        ...
        runChuck(code);
        assertTrue(errorOutput.stream().anyMatch(s -> s.contains("cannot access protected field 'x'")),
