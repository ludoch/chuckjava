...
/**
 * Tests for the full Machine shred API and me.* shred API.
 * All tests use the ANTLR pipeline.
 */
public class ChuckMachineApiTest {
    ...
    public void testMachineEval() throws InterruptedException {
        ...
        long sid = -1;
        for (String line : out) {
            try { sid = Long.parseLong(line.trim()); break; } catch (NumberFormatException ignored) {}
        }
