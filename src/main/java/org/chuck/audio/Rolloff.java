...
/**
 * Rolloff: Spectral Rolloff unit analyzer.
 * Measures the frequency below which a certain percentage of energy resides.
 */
public class Rolloff extends UAna {
    private float percent = 0.85f;

    public void percent(float p) { this.percent = p; }
