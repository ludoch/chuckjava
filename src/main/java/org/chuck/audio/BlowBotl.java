...
/**
 * BlowBotl — Blown bottle physical model.
 * Breath noise drives a resonant cavity (single-pole tube resonance)
 * with non-linear jet feedback, producing a breathy bottle sound.
 */
public class BlowBotl extends ChuckUGen {
    ...
    public void noteOn(float v)  { pressure = 0.1f + v * 0.9f; env.keyOn(); }
