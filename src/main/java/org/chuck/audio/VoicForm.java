...
/**
 * VoicForm — 4-formant singing voice synthesizer.
 * A buzz (pulsed glottal wave) drives 4 bandpass resonators tuned to
 * formant frequencies that define the vowel quality.
 *
 * Formant presets (phoneme index via phoneme()):
 *   0="eee", 1="ihh", 2="ehh", 3="aaa", 4="ahh", 5="aww", 6="ohh", 7="uhh"
 */
