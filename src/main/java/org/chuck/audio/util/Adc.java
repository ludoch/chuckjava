 ...
 *
 * <p>Sits at the root of the capture side of the audio graph. The audio engine writes one
 * sample-pair per sample period via {@link #setInputSample}; the UGen graph then pulls that value
 * through whatever is chucked to 'adc'.
 *
 * <p>Stereo: channel 0 = left, channel 1 = right. {@link #compute} returns the average of L+R (mono
 * mix) scaled by gain.
 */
