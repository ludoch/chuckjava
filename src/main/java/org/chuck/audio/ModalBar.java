...
/**
 * ModalBar — modal-resonance bar physical model.
 * Models a struck bar (xylophone, vibraphone, marimba) using a superposition
 * of exponentially-decaying sinusoidal modes.
 *
 * The first 4 modes follow a typical bar inharmonic series.
 * Mode ratios: 1.0, 3.984, 10.00, 19.33 (marimba default).
 */
