 ...
 *
 * Computes MFCCs from the audio signal in frames:
 *   1. Accumulate samples into a frame buffer.
 *   2. Compute FFT magnitude spectrum.
 *   3. Apply mel-scale triangular filterbank.
 *   4. Take log of filterbank energies.
 *   5. Apply DCT-II to get cepstral coefficients.
 *
 * Default: 13 coefficients, 26 mel filters, 512-sample frames, 44100 Hz.
 */
public class MFCC extends UAna {
     ...
     * Intentionally simple for correctness; adequate for offline/slow analysis.
     */
    ...
    public int getNumCoeffs()  { return numCoeffs; }
