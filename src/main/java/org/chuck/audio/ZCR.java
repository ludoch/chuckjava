...
/**
 * ZCR — Zero Crossing Rate UAna.
 * Counts zero crossings per analysis frame and outputs the rate (0.0 to 1.0).
 * UAna-style: accumulates samples in a buffer, computes rate when full.
 */
public class ZCR extends UAna {
    ...
    public float getZCR() { return result; }
