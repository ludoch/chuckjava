...
/**
 * BandedWG — Banded Waveguide model (bowed bar, tibetan bowl).
 * Uses a set of waveguide resonators at inharmonic mode frequencies,
 * excited by a noise burst and sustained by bow-friction feedback.
 */
