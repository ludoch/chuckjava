 ...
 *
 * <p>Measures tonality vs. noisiness of a spectrum. 0.0 = perfectly tonal (pure tone), 1.0 =
 * perfectly noisy (white noise).
 *
 * <p>Formula: SFM = exp(mean(log(|X[k]|))) / mean(|X[k]|) = geometric mean of magnitude /
 * arithmetic mean of magnitude
 *
 * <p>Connect after FFT: adc => FFT fft =^ SFM sfm; sfm.upchuck(); sfm.fval() // Spectral Flatness
 * value 0.0–1.0
 */
