...
/**
 * Gen9: Sum of sinusoids with arbitrary frequency, amplitude, and phase ratios. ChucK: [1.0, 1.0,
 * 0.0, 2.0, 0.5, 0.0] => gen9.coeffs; // [freq, amp, phase, ...]
 */
public class Gen9 extends GenX {
  public Gen9(float sampleRate) {
    super(sampleRate);
  }
