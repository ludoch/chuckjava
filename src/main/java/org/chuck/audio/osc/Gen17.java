...
/**
 * Gen17: Chebyshev polynomials of the first kind. Used for wavefolding/distortion. ChucK: [1.0,
 * 0.5, 0.25] => gen17.coeffs; // coefficients for T1, T2, T3...
 */
public class Gen17 extends GenX {
  public Gen17(float sampleRate) {
    super(sampleRate);
  }
