...
/**
 * Biquad (second-order IIR) resonator filter.
 * Supports prad (pole radius), pfreq (pole frequency Hz), gain, and eqzs.
 */
public class BiQuad extends ChuckUGen {
    ...
    public void setPrad(double r)  { this.prad  = r;         updateCoeffs(); }
