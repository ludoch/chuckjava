...
/**
 * HnkyTonk — FM honky-tonk piano. Produces the classic out-of-tune piano sound by detuning two sets
 * of FM operator pairs a few cents apart.
 */
public class HnkyTonk extends ChuckUGen {
  ...
  public void setFreq(double f) {
    ...
    modA.setFreq(f);
    carA.setFreq(f);
    modB.setFreq(f * DETUNE);
    carB.setFreq(f * DETUNE);
  }
