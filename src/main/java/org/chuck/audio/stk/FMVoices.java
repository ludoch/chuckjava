...
/**
 * FMVoices — Singing voice synthesis using 4-operator FM. Formant-like filtering via multiple FM
 * operators tuned to vocal tract resonances. Slow vibrato applied to carrier for natural voice.
 */
