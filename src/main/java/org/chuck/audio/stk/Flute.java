...
/**
 * Flute: STK physical model of a flute. Uses a jet-reflection waveguide with non-linear feedback.
 */
public class Flute extends ChuckUGen {
  ...
  protected float compute(float input, long systemTime) {
    ...
    float out =
        delayLine.tick(breath + filter.tick(jetOutput * endReflection, systemTime), systemTime);
