...
/**
 * BiQuadStk — STK-style BiQuad filter (second-order IIR).
 * Coefficients set via b0/b1/b2 (feedforward) and a1/a2 (feedback).
 * Distinct from BiQuad (which uses prad/pfreq API).
 */
public class BiQuadStk extends FilterStk {
    ...
    public BiQuadStk(float sampleRate) { super(sampleRate); }
    ...
    @Override
    public void clear() { x1=x2=y1=y2=0; }
