 ...
 * 
 * Takes spectral data (Complex bins) and converts it back to time-domain samples.
 * Usually connected after an FFT or other spectral processor:
 * FFT f => IFFT i => dac;
 */
