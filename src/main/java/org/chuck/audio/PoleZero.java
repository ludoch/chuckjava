 ...
 *
 * Convenience methods: setAllpass(coeff) for unity-gain allpass,
 * setBlockZero(pole) for DC blocker.
 */
public class PoleZero extends ChuckUGen {
    ...
    /**
     * DC blocking filter: b0=1, b1=-1, a1=-pole (typically pole ≈ 0.99).
     * High-passes with very low cutoff.
     */
