...
/**
 * Pitch-shifting delay using two crossfading read-heads. Compatible with the ChucK DelayP API:
 * delay(samples), max(samples), shift(semitones).
 */
public class DelayP extends ChuckUGen {
  ...
  public double shift() {
    return 12.0 * Math.log(shiftRate) / Math.log(2.0);
  }
