...
/**
 * Dyno: Dynamics Processor (Compressor, Limiter, Expander, Noise Gate).
 * Implemented with an envelope follower and gain computer.
 */
public class Dyno extends ChuckUGen {
    ...
    // --- Properties ---
    public void mode(int m) { this.mode = m; }
    public int mode() { return mode; }

    public void thresh(float v) { this.thresh = v; }
    public float thresh() { return thresh; }

    public void ratio(float v) { this.ratio = v; }
    public float ratio() { return ratio; }

    public void attackTime(double durSamples) { this.attackTime = (float)(durSamples / sampleRate); }
    public double attackTime() { return attackTime * sampleRate; }

    public void releaseTime(double durSamples) { this.releaseTime = (float)(durSamples / sampleRate); }
    public double releaseTime() { return releaseTime * sampleRate; }

    public void slopeAbove(float v) { this.slopeAbove = v; }
    public float slopeAbove() { return slopeAbove; }

    public void slopeBelow(float v) { this.slopeBelow = v; }
    public float slopeBelow() { return slopeBelow; }
    ...
    public void compressor() { this.mode = COMPRESSOR; }
    public void limiter() { this.mode = LIMITER; }
    public void expander() { this.mode = EXPANDER; }
    public void gate() { this.mode = GATE; }
    public void duck() { this.mode = DUCK; }
}
