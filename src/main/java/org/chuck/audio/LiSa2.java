...
/**
 * LiSa2: Stereo Live Sampling Utility.
 */
public class LiSa2 extends StereoUGen {
    ...
    public LiSa2(float sampleRate) {
        super();
        this.sampleRate = sampleRate;
        this.buffer = new float[2][(int)sampleRate]; // 1 second default
    ...
    public void duration(long samples) {
        this.buffer = new float[2][(int)samples];
        this.recPos = 0;
    }
