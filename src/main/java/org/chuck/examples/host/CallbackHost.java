...
/**
 * Example 2: Custom Audio Callback Hosting Demonstrates how to drive the ChuckVM manually within a
 * custom audio loop. This pattern is common when embedding ChucK in game engines or DAW plugins.
 */
