...
public class ChuckASTVisitor extends ChuckANTLRBaseVisitor<Object> {
  ...
  public List<ChuckAST.Stmt> visitProgram(ProgramContext ctx) {
    ...
    for (org.antlr.v4.runtime.tree.ParseTree c : ctx.children) {
      if (c instanceof TerminalNode tn
          && tn.getSymbol().getType() == ChuckANTLRParser.DOC_COMMENT) {
  ...
  public ChuckAST.Stmt visitDirective(DirectiveContext ctx) {
    ...
    if (ctx.IMPORT() != null) {
      ...
      return new ChuckAST.ImportStmt(
          path, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
    }
  ...
  public ChuckAST.Stmt visitBreakStmt(BreakStmtContext ctx) {
    return new ChuckAST.BreakStmt(ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Stmt visitExpressionStmt(ExpressionStmtContext ctx) {
    ...
    return new ChuckAST.BlockStmt(
        stmts, false, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Stmt visitSwitchStatement(SwitchStatementContext ctx) {
    ...
    return new ChuckAST.SwitchStmt(
        cond, cases, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Stmt visitForStatement(ForStatementContext ctx) {
    ...
    while (childIdx < ctx.getChildCount()
        && ctx.getChild(childIdx) instanceof TerminalNode tn
        && tn.getSymbol().getType() == ChuckANTLRParser.DOC_COMMENT) {
      lastDocComment = cleanDoc(tn.getText());
      childIdx++;
    }
  ...
  public ChuckAST.Stmt visitReturnStatement(ReturnStatementContext ctx) {
    ...
    return new ChuckAST.ReturnStmt(
        exp, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Stmt visitPrintStatement(PrintStatementContext ctx) {
    ...
    return new ChuckAST.PrintStmt(
        exps, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Stmt visitBlockStatement(BlockStatementContext ctx) {
    ...
    return new ChuckAST.BlockStmt(
        stmts, true, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
      ...
      if (v.CHUCK_OP() != null) {
        ...
        decls.add(
            new ChuckAST.BinaryExp(
                declExp, op, rhs, v.getStart().getLine(), v.getStart().getCharPositionInLine()));
      } else {
        decls.add(declExp);
      }
    }
    ...
    if (rExp == null)
      throw new RuntimeException(
          ctx.getStart().getLine()
              + ":"
              + ctx.getStart().getCharPositionInLine()
              + ": error: right operand of '=>' is null ("
              + ctx.expression(1).getText()
              + ")");

    return new ChuckAST.BinaryExp(
        lExp, op, rExp, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
    ...
    if (opStr.startsWith("spork")) {
      if (subExp instanceof ChuckAST.CallExp callExp) {
        return new ChuckAST.SporkExp(
            callExp, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
      }
    }
    return new ChuckAST.UnaryExp(
        op, subExp, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitIntLit(IntLitContext ctx) {
    ...
    return new ChuckAST.IntExp(
        val, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitStringLit(StringLitContext ctx) {
    ...
    return new ChuckAST.StringExp(
        unescape(content), ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitTrueLit(TrueLitContext ctx) {
    return new ChuckAST.IntExp(1, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitNullLit(NullLitContext ctx) {
    return new ChuckAST.IdExp(
        "null", ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }

  @Override
  public ChuckAST.Exp visitNowExp(NowExpContext ctx) {
    return new ChuckAST.IdExp(
        "now", ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }

  @Override
  public ChuckAST.Exp visitMeExp(MeExpContext ctx) {
    return new ChuckAST.MeExp(ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitArrayAccessExp(ChuckANTLRParser.ArrayAccessExpContext ctx) {
    ...
    return new ChuckAST.ArrayAccessExp(
        base, indices, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitCastExp(ChuckANTLRParser.CastExpContext ctx) {
    ...
    return new ChuckAST.CastExp(
        value, targetType, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitArrayLitExp(ArrayLitExpContext ctx) {
    ...
    return new ChuckAST.ArrayLitExp(
        elements, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitTypeofExp(ChuckANTLRParser.TypeofExpContext ctx) {
    ...
    return new ChuckAST.TypeofExp(
        expr, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
  ...
  public ChuckAST.Exp visitInstanceofExp(ChuckANTLRParser.InstanceofExpContext ctx) {
    ...
    return new ChuckAST.InstanceofExp(
        expr, typeName, ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine());
  }
