...
public class ChuckEmitter {
    ...
    public Map<String, ChuckCode> getFunctions() { return functions; }
    public java.util.Stack<Map<String, Integer>> getLocalScopes() { return localScopes; }
    public java.util.Stack<Map<String, String>> getLocalTypeScopes() { return localTypeScopes; }
    public java.util.Set<String> getConstants() { return constants; }
    public int getLocalCount() { return localCount; }
    public void setLocalCount(int localCount) { this.localCount = localCount; }
    public boolean isInPreCtor() { return inPreCtor; }
    public void setInPreCtor(boolean inPreCtor) { this.inPreCtor = inPreCtor; }
    public Map<String, UserClassDescriptor> getUserClassRegistry() { return userClassRegistry; }
    public Map<String, String> getGlobalVarTypes() { return globalVarTypes; }
    ...
    public java.util.Set<String> getCurrentClassFields() { return currentClassFields; }
    public void setCurrentClassFields(java.util.Set<String> currentClassFields) { this.currentClassFields = currentClassFields; }
    public String getCurrentFile() { return currentFile; }
    public java.util.Stack<List<Integer>> getBreakJumps() { return breakJumps; }
    public java.util.Stack<List<Integer>> getContinueJumps() { return continueJumps; }
    public String getCurrentFuncReturnType() { return currentFuncReturnType; }
    public void setCurrentFuncReturnType(String currentFuncReturnType) { this.currentFuncReturnType = currentFuncReturnType; }
    public boolean isCurrentFuncHasReturn() { return currentFuncHasReturn; }
    public void setCurrentFuncHasReturn(boolean currentFuncHasReturn) { this.currentFuncHasReturn = currentFuncHasReturn; }
    public boolean isInStaticFuncContext() { return inStaticFuncContext; }
    public void setInStaticFuncContext(boolean inStaticFuncContext) { this.inStaticFuncContext = inStaticFuncContext; }
    public java.util.Set<String> getEmptyArrayVars() { return emptyArrayVars; }
    ...
    String getOpSymbol(ChuckAST.Operator op) {
        return switch (op) {
            ...
            case PERCENT -> "%"; case LT -> "<"; case LE -> "<="; case GT -> ">";
