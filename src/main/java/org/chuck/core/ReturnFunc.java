...
/**
 * Returns from a function call. Restores the previous PC, Code, and reg stack pointer from the mem
 * stack, discarding any leaked arguments and preserving the return value (if any).
 */
