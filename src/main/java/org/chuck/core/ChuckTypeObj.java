...
/**
 * ChuckTypeObj — runtime Type object exposed to ChucK programs. Returned by typeof(expr) when used
 * as an object (vs string). Wraps a type name and optional parent name for basic introspection.
 *
 * <p>ChucK API: Type t; typeof(x) => t; t.name() => string; t.parent() => Type; t.methods() =>
 * Function[];
 */
public class ChuckTypeObj extends ChuckObject {
  ...
  public ChuckTypeObj(String typeName) {
    this(typeName, null, null);
  }

  /** Returns the type name as a string. */
  public ChuckString name() {
    return new ChuckString(typeName);
  }
  ...
  public long eq(ChuckTypeObj other) {
    return other != null && typeName.equals(other.typeName) ? 1L : 0L;
  }
