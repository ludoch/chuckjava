...
/**
 * ChuckFunction — runtime representation of a ChucK function/method.
 * Provides introspection API: name(), numArgs(), returnType().
 */
public class ChuckFunction extends ChuckObject {
    ...
    public ChuckString name() { return new ChuckString(name); }

    /** Returns the number of arguments. */
    public long numArgs() { return (long) numArgs; }

    /** Returns the return type as a string. */
    public ChuckString returnType() { return new ChuckString(returnType); }
