...
/**
 * K-Nearest Neighbor — regression variant.
 * Stores (feature_vector, output_vector) pairs and predicts via weighted average of k nearest.
 */
public class KNN extends ChuckObject {

    public KNN() { super(ChuckType.OBJECT); }
