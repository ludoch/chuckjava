...
/**
 * Reads a field from the current 'this' object (top of the shred's thisStack). Emitted for bare
 * field-name references inside user-defined class methods.
 */
public class GetUserField implements ChuckInstr {
  private final String name;

  public GetUserField(String name) {
    this.name = name;
  }
