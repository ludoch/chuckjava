...
public class FieldInstrs {
            ...
            if (obj instanceof ChuckArray arr && arr.vecTag != null) {
                ...
                try {
                    ...
                    if (n.equals("freq")) s.reg.push(co.getDataAsDouble(0));
                        ...
                        if (co instanceof org.chuck.audio.ChuckUGen ugen) s.reg.push((double)ugen.getLastOut());
                        else s.reg.push(0.0);
                    }
                    else s.reg.push(0L);
                }
            ...
            if (obj instanceof ChuckArray arr && arr.vecTag != null) {
                ...
                try {
                    ...
                    if (n.equals("freq")) co.setData(0, s.reg.peekAsDouble(0));
                        ...
                        if (co instanceof org.chuck.audio.ChuckUGen ugen) ugen.setGain((float)s.reg.peekAsDouble(0));
    ...
    public static class GetBuiltinStatic implements ChuckInstr {
        ...
        public GetBuiltinStatic(String c, String f) { className = c; fieldName = f; }
        @Override public void execute(ChuckVM vm, ChuckShred s) {
            try {
