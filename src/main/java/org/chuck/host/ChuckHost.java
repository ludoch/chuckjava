...
/**
 * ChuckHost provides a high-level, unified API for embedding ChucK-Java into other Java
 * applications. It orchestrates the VM, compiler, and optional audio engines.
 */
public class ChuckHost {
  ...
  /**
   * Advances the VM time manually. Use this if you are NOT using 'withAudio' and want to drive the
   * engine from your own callback.
   *
  ...
  /**
   * Returns the last computed sample for a DAC channel. Useful for custom audio callback patterns.
   */
